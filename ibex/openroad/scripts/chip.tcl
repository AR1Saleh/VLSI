...
set proj_name ibex_chip
set netlist /foss/designs/ibex/yosys/out/ibex_wrap_yosys.v
set top_design ibex_wrap
...
# Disable GUI image generation (for headless runs)
proc report_image {args} {
    puts "Skipping image generation (headless mode)"
}
